...
# WARNING: Ensure imports from `connect_ml_api` comes after this line
from connect_ml_api import app, settings, db  # noqa
from connect_ml_api.cli import create_user, cli  # noqa
