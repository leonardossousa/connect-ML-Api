...
description = """
connect_ml_api API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="connect_ml_api",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://connect_ml_api.com/terms/",
    contact={
        "name": "leonardossousa",
        "url": "http://connect_ml_api.com/contact/",
        "email": "leonardossousa@connect_ml_api.com",
    },
    license_info={
        "name": "The Unlicense",
